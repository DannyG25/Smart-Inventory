...
func Routers() *gin.Engine {
	...
	usersRouter.GET("/usersid/:id", users.GetUsersID)
	usersRouter.GET("/employees/:id", users.GetEmployees)
	...
	transactionsRouter.GET("/transactionsid/:id", transaction.GetTransactionsID)
	...
	inventoriesRouter.GET("/inventoriesid/:id", inventory.GetInventoriesID)
